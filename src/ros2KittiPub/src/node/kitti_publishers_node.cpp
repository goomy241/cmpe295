...
void KittiPublishersNode::init_file_path()
{
    ...
    path_point_cloud_ = kitti_path_ + "/velodyne_points/data/";
    path_image_gray_left_ = kitti_path_ + "/image_00/data/";
    path_image_gray_right_ = kitti_path_ + "/image_01/data/";
    path_image_color_left_ = kitti_path_ + "/image_02/data/";
    path_image_color_right_ = kitti_path_ + "/image_03/data/";
    path_oxts_ = kitti_path_ + "/oxts/data/";
}
